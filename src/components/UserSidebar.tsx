      ...
      <SidebarContent>
        <div className="w-full h-dvh flex flex-col items-center gap-6 py-2">
          ...
          <div
            ...
            className="bg-zinc-100 cursor-pointer  hover:bg-zinc-200 size-12 rounded-full flex items-center transition duration-300 hover:rounded-2xl justify-center "
          >
